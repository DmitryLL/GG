// Скилл 5: Призрачный залп — 5 стрел в конусе по углам [-0.35,-0.17,0,0.17,0.35] рад.
// Каждая стрела — ray-cast 220px, попадает в первого моба в 24px от луча.
// Урон ~80% от computeDamage. Каждая стрела — отдельный набор попаданий.
registerSkill(5, function (ctx: SkillContext): void {
